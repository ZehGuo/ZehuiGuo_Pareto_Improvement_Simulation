...
legend('${\rm BR}^1_1$','${\rm BR}^1_2$','$\tilde{\rm BR}^1_1$','${\rm BR}^2_1$','${\rm BR}^2_2$','$\tilde{\rm BR}^2_1$','$\hat{x}^*$','$\mathcal{D}_{\rm bud}(\sigma)$','original trajectory','incentivized trajectory');
